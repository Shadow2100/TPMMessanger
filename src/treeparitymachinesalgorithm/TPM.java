package treeparitymachinesalgorithm;
...
public class TPM{
    ...
    public byte[] getWeight(){
        ...
        ByteBuffer byteBuffer = ByteBuffer.allocate(w.length * 4);        
...
//    public byte[] makeKeyBinary(){
//        int size1=(int) (Math.log(L*2+1)/Math.log(2));
//        ArrayList<String> binaryTemp=new ArrayList();
//        
//        
//        StringBuilder key=new StringBuilder();
//        int keySize=(int)(ABC.length()/(L*2+1));
